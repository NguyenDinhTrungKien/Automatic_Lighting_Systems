...
//
// V1.05
// 03012017_1 Fixed: images with more than 65535 pixels from external memory 
...
#if defined(_MODEL_MEDIUM_) || defined(_MODEL_LARGE_) || (_GLCD_MAXX_*_GLCD_MAXY_>65535L) // 03012017_1
